...
var HomerReactScroller = __webpack_require__(1);
...
var Impetus = __webpack_require__(12);

var HomerReactScroller = function (_React$Component) {
  _inherits(HomerReactScroller, _React$Component);

  function HomerReactScroller(props) {
    _classCallCheck(this, HomerReactScroller);

    var _this = _possibleConstructorReturn(this, (HomerReactScroller.__proto__ || Object.getPrototypeOf(HomerReactScroller)).call(this, props));
    ...
    _this.momentum = _this.momentum.bind(_this);
    _this.setup = _this.setup.bind(_this);
    _this.scroll = _this.scroll.bind(_this);
    _this.calculateMaxScroll = _this.calculateMaxScroll.bind(_this);
    return _this;
  }

  _createClass(HomerReactScroller, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var viewport = this.props.viewportSelector ? document.querySelector(this.props.viewportSelector) : _reactDom2.default.findDOMNode(this);
      ...
      this.setState({
        ...
        window.addEventListener('resize', _this2.setup, false);
        window.addEventListener('load', _this2.setup, false);
        if (_this2.isMobile()) {
          window.addEventListener('orientationchange', _this2.calculateMaxScroll);
        }
      });
    }
  }, {
    ...
    value: function componentDidUpdate(props) {
      if (!(0, _lodash2.default)(this.props, props)) {
        this.setup();
      }
    }
  }, {
    ...
    key: 'setWidthForYScroll',
    value: function setWidthForYScroll() {
      var target = this.state.target;
      var totalWidth = 0;
      target.childNodes.forEach(function (element) {
    ...
    key: 'calculateMaxScroll',
    value: function calculateMaxScroll() {
      ...
      if (target.offsetHeight > viewport.offsetHeight || target.offsetWidth > viewport.offsetWidth) {
        ...
        this.targetHeight = target.offsetHeight, this.maxScroll = maxScroll + this.state.overscroll;
      }
    }
  }, {
    key: 'scrollToBottom',
    ...
    key: 'momentum',
    value: function momentum(x, y) {
      if (this.isMobile()) {
        var delta = this.state.upDown ? y : x;
        var deltaRounded = Math.floor(delta);
    ...
    value: function scroll(e) {
      ...
      var newMargin = Math.abs(newScroll) <= this.maxScroll ? newScroll : Math.min(-this.maxScroll, 0);
    ...
    value: function render() {
      ...
      var el = _react2.default.createElement(this.props.component, props, this.props.children);
      return el;
    }
  }]);

  return HomerReactScroller;
}(_react2.default.Component);

HomerReactScroller.propTypes = {
  viewportSelector: _propTypes2.default.element,
  className: _propTypes2.default.string,
  component: _propTypes2.default.string,
  scrollDirection: _propTypes2.default.string,
  scrollSelector: _propTypes2.default.string,
  overscroll: _propTypes2.default.number,
  setMaxHeight: _propTypes2.default.bool,
  update: _propTypes2.default.bool,
  impetusEnabled: _propTypes2.default.bool
};
...
exports.default = HomerReactScroller;
